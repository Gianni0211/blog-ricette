...
<div class="row mb-sm-5 mb-md-5 mt-sm-5 mt-md-5">
    <div class="col-md-7">
        <a href="#">
            <img class="img-fluid img-card rounded mb-3 mb-md-0" src="{{ Storage::url($post->img) }}" alt="">
        </a>
    </div>
    <div class="col-md-5">
        <h3>{{ $post->title }}</h3>
        ...
        <p class="lead font-weight-bold"><strong>Autore:</strong> {{ $post->user->name }}</p>
    <p class="small mb-4"> Pubblicato il: {{ explode(' ',$post->created_at)[0]}}</p>
