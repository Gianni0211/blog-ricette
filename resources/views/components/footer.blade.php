...
<footer class="page-footer bg-secondario mt-5">
    ...
    <!-- Footer Links -->
    <div class="container text-sm-left text-md-left text-md-left mt-5">
      ...
      <div class="row mt-3 text-white">
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <!-- Links -->
          <h6 class="text-uppercase font-weight-bold text-primario h4 hr-foot pb-2">Contatti</h6>
            ...
            <p>
              ...
              <p>
                ...
                <div class="col-12 col-md-4 col-lg-4 col-xl-4 mb-4">
                  ...
                  <!-- Content -->
                  <h6 class="text-uppercase font-weight-bold text-primario h4 hr-foot pb-2">Newsletter</h6>
                  <p>Rimani aggiornato su tutte le novità. No spam!</p>
                  ...
                  <form class="text-center p-2" action="#!">
                    ...
                    <!-- Name -->
                    <input type="text" id="defaultSubscriptionFormPassword" class="form-control mb-4" placeholder="Nome">
